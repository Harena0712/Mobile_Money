...
<head>
    ...
    <style>
        ...
        input[type="number"],
        input[type="tel"] { width: 100%; padding: 10px 12px; border: 1px solid #ccc; border-radius: 6px; box-sizing: border-box; }
...
<body>
    <div class="container">
        ...
        <p class="hint">Les frais sont calculés automatiquement selon le montant transféré.</p>
        ...
        <form action="/client/transfert" method="post">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="telephone_destination" name="telephone_destination" placeholder="0340000000" value="<?= old('telephone_destination') ?>" required>
            </div>
