...
<div class="panel">
    ...
    <?php if (!empty($totaux_par_operateur) && is_array($totaux_par_operateur)) : ?>
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php foreach ($totaux_par_operateur as $total) : ?>
                        <tr
                            onclick="window.location='<?= site_url('compensation/detail/' . urlencode($total['operateur'])) ?>';"
                            style="cursor: pointer;">
                            <td><?= esc($total['operateur']) ?></td>
                            <td>
                                <span class="badge badge-orange">
                                    <?= number_format((float) $total['montant'], 2, '.', ' ') ?> Ar
                                </span>
                            </td>
                        </tr>
                    <?php endforeach; ?>
