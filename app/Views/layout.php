        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= site_url('operateur/typesOperation') ?>"
               class="nav-link <?= strpos(current_url(), 'typesOperation') !== false ? 'active' : '' ?>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M17 2l4 4-4 4M21 6H7a4 4 0 00-4 4M7 22l-4-4 4-4M3 18h14a4 4 0 004-4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </span>
                Types d'opérations
            </a>
            ...
            <a href="<?= site_url('operateur/situationFrais') ?>"
               class="nav-link <?= strpos(current_url(), 'situationFrais') !== false ? 'active' : '' ?>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2v20M17 6.5c0-1.93-2.24-3.5-5-3.5s-5 1.57-5 3.5 2.24 3.5 5 3.5 5 1.57 5 3.5-2.24 3.5-5 3.5-5-1.57-5-3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                </span>
                Situation des frais
            </a>
            ...
            <a href="<?= site_url('operateur/situationComptes') ?>"
               class="nav-link <?= strpos(current_url(), 'situationComptes') !== false ? 'active' : '' ?>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="10" width="18" height="9" rx="1.5" stroke="currentColor" stroke-width="1.8"/><path d="M3 10l9-6 9 6M7 14v2M12 14v2M17 14v2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                </span>
        ...
        <div class="sidebar-footer">
            <div class="operator-chip">
                ...
                <div class="operator-meta">
                    <span class="operator-name">Espace Opérateur</span>
                    <span class="operator-sub">MoneyFlow Admin</span>
                </div>
            </div>
        </div>
    </aside>
